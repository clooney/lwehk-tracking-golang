# LWE Tracking API For Golang
LWE Tracking API and webhook make it easy to integrate LWE Tracking function into your own project. Support APIs Client Libraries for golang

### API key

In order to use this API, you need to generate a LWE Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use LWE Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [LWE Tracking API](https://www.trackingmore.com/lwehk-tracking.html)  to:

   *   Get LWE realtime tracking info of muti-carriers in one integration
   *   Provide LWE shipment tracking experience like Amazon
   *   Push LWE notifications of package update with webhook
   *   Verify LWE delivery exception before it is too late
